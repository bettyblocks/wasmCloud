...
type Service struct {
	...
	// Precompiled variants published for this service's component. The host
	// prefers a matching variant to inline compilation.
	Precompiled   []*PrecompiledVariant `protobuf:"bytes,6,rep,name=precompiled,proto3" json:"precompiled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Service) GetPrecompiled() []*PrecompiledVariant {
	if x != nil {
...
type Component struct {
	...
	// Precompiled variants published for this component. The host prefers a
	// matching variant to inline compilation.
	Precompiled   []*PrecompiledVariant `protobuf:"bytes,8,rep,name=precompiled,proto3" json:"precompiled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Component) GetPrecompiled() []*PrecompiledVariant {
	if x != nil {
		return x.Precompiled
	}
	return nil
...
// A precompiled `.cwasm` published for a specific host configuration. The host
// uses a variant only when all three of (target, wasmtime_version, compat_hash)
// match its own values; any mismatch falls back to pulling and compiling the
// source `.wasm`.
type PrecompiledVariant struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Target triple this variant was compiled for, e.g. "x86_64-unknown-linux-gnu".
	Target string `protobuf:"bytes,1,opt,name=target,proto3" json:"target,omitempty"`
	// Exact wasmtime crate version the precompile worker was built against.
	WasmtimeVersion string `protobuf:"bytes,2,opt,name=wasmtime_version,json=wasmtimeVersion,proto3" json:"wasmtime_version,omitempty"`
	// Stable hex string from Engine::precompile_compatibility_hash.
	CompatHash string `protobuf:"bytes,3,opt,name=compat_hash,json=compatHash,proto3" json:"compat_hash,omitempty"`
	...
	// sha256 digest of the precompiled bytes.
	Digest        string `protobuf:"bytes,5,opt,name=digest,proto3" json:"digest,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PrecompiledVariant) Reset() {
	*x = PrecompiledVariant{}
	mi := &file_wasmcloud_runtime_v2_workload_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PrecompiledVariant) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrecompiledVariant) ProtoMessage() {}

func (x *PrecompiledVariant) ProtoReflect() protoreflect.Message {
	mi := &file_wasmcloud_runtime_v2_workload_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrecompiledVariant.ProtoReflect.Descriptor instead.
func (*PrecompiledVariant) Descriptor() ([]byte, []int) {
	return file_wasmcloud_runtime_v2_workload_proto_rawDescGZIP(), []int{4}
}

func (x *PrecompiledVariant) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *PrecompiledVariant) GetWasmtimeVersion() string {
	if x != nil {
...
func (x *PrecompiledVariant) GetCompatHash() string {
	if x != nil {
		return x.CompatHash
	}
	return ""
...
func (x *PrecompiledVariant) GetArtifactUrl() string {
	if x != nil {
...
func (x *PrecompiledVariant) GetDigest() string {
	if x != nil {
		return x.Digest
	}
	return ""
...
func (x *ImagePullSecret) Reset() {
	*x = ImagePullSecret{}
	mi := &file_wasmcloud_runtime_v2_workload_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ImagePullSecret) Descriptor() ([]byte, []int) {
	return file_wasmcloud_runtime_v2_workload_proto_rawDescGZIP(), []int{10}
}
...
var file_wasmcloud_runtime_v2_workload_proto_rawDesc = string([]byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x83, 0x03, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1b, 0x0a, 0x17, 0x57, 0x4f, 0x52, 0x4b, 0x4c, 0x4f, 0x41,
	0x44, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x49, 0x4e, 0x47,
	0x10, 0x01, 0x12, 0x1a, 0x0a, 0x16, 0x57, 0x4f, 0x52, 0x4b, 0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x53,
	0x54, 0x41, 0x54, 0x45, 0x5f, 0x52, 0x55, 0x4e, 0x4e, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x12, 0x1c,
	0x0a, 0x18, 0x57, 0x4f, 0x52, 0x4b, 0x4c, 0x4f, 0x41, 0x44, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45,
	...
	,
...
var file_wasmcloud_runtime_v2_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_wasmcloud_runtime_v2_workload_proto_goTypes = []any{
	...
	(*PrecompiledVariant)(nil), // 6: wasmcloud.runtime.v2.PrecompiledVariant
	(*LocalResources)(nil),     // 7: wasmcloud.runtime.v2.LocalResources
	(*Volume)(nil),             // 8: wasmcloud.runtime.v2.Volume
	(*VolumeMount)(nil),        // 9: wasmcloud.runtime.v2.VolumeMount
	(*EmptyDirVolume)(nil),     // 10: wasmcloud.runtime.v2.EmptyDirVolume
	(*HostPathVolume)(nil),     // 11: wasmcloud.runtime.v2.HostPathVolume
	(*ImagePullSecret)(nil),    // 12: wasmcloud.runtime.v2.ImagePullSecret
	nil,                        // 13: wasmcloud.runtime.v2.Workload.AnnotationsEntry
	nil,                        // 14: wasmcloud.runtime.v2.LocalResources.ConfigEntry
	nil,                        // 15: wasmcloud.runtime.v2.LocalResources.EnvironmentEntry
	(*WitInterface)(nil),       // 16: wasmcloud.runtime.v2.WitInterface
}
var file_wasmcloud_runtime_v2_workload_proto_depIdxs = []int32{
	13, // 0: wasmcloud.runtime.v2.Workload.annotations:type_name -> wasmcloud.runtime.v2.Workload.AnnotationsEntry
	...
	8,  // 3: wasmcloud.runtime.v2.Workload.volumes:type_name -> wasmcloud.runtime.v2.Volume
	7,  // 4: wasmcloud.runtime.v2.Service.local_resources:type_name -> wasmcloud.runtime.v2.LocalResources
	12, // 5: wasmcloud.runtime.v2.Service.image_pull_secret:type_name -> wasmcloud.runtime.v2.ImagePullSecret
	1,  // 6: wasmcloud.runtime.v2.Service.image_pull_policy:type_name -> wasmcloud.runtime.v2.ImagePullPolicy
	6,  // 7: wasmcloud.runtime.v2.Service.precompiled:type_name -> wasmcloud.runtime.v2.PrecompiledVariant
	5,  // 8: wasmcloud.runtime.v2.WitWorld.components:type_name -> wasmcloud.runtime.v2.Component
	16, // 9: wasmcloud.runtime.v2.WitWorld.host_interfaces:type_name -> wasmcloud.runtime.v2.WitInterface
	7,  // 10: wasmcloud.runtime.v2.Component.local_resources:type_name -> wasmcloud.runtime.v2.LocalResources
	12, // 11: wasmcloud.runtime.v2.Component.image_pull_secret:type_name -> wasmcloud.runtime.v2.ImagePullSecret
	1,  // 12: wasmcloud.runtime.v2.Component.image_pull_policy:type_name -> wasmcloud.runtime.v2.ImagePullPolicy
	6,  // 13: wasmcloud.runtime.v2.Component.precompiled:type_name -> wasmcloud.runtime.v2.PrecompiledVariant
	14, // 14: wasmcloud.runtime.v2.LocalResources.config:type_name -> wasmcloud.runtime.v2.LocalResources.ConfigEntry
	15, // 15: wasmcloud.runtime.v2.LocalResources.environment:type_name -> wasmcloud.runtime.v2.LocalResources.EnvironmentEntry
	9,  // 16: wasmcloud.runtime.v2.LocalResources.volume_mounts:type_name -> wasmcloud.runtime.v2.VolumeMount
	11, // 17: wasmcloud.runtime.v2.Volume.host_path:type_name -> wasmcloud.runtime.v2.HostPathVolume
	10, // 18: wasmcloud.runtime.v2.Volume.empty_dir:type_name -> wasmcloud.runtime.v2.EmptyDirVolume
...
func file_wasmcloud_runtime_v2_workload_proto_init() {
	...
	file_wasmcloud_runtime_v2_workload_proto_msgTypes[6].OneofWrappers = []any{
		(*Volume_HostPath)(nil),
		(*Volume_EmptyDir)(nil),
	}
	type x struct{}
