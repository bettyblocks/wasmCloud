...
type Component struct {
	...
	// Example: { "wasi:http/incoming-handler": { config: { "path": "/user/{id}" } } }
	// This is the preferred way to provide per-component interface overrides.
	InterfaceConfig map[string]*InterfaceConfig `protobuf:"bytes,8,rep,name=interface_config,json=interfaceConfig,proto3" json:"interface_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Component) GetInterfaceConfig() map[string]*InterfaceConfig {
	if x != nil {
...
// Configuration for a specific WIT interface on a component.
...
func (x *InterfaceConfig) GetConfig() map[string]string {
	if x != nil {
		return x.Config
	}
	return nil
...
const file_wasmcloud_runtime_v2_workload_proto_rawDesc = "" +
	"\n" +
	"#wasmcloud/runtime/v2/workload.proto\x12\x14wasmcloud.runtime.v2\x1a(wasmcloud/runtime/v2/wit_interface.proto\"\xfd\x02\n" +
	"\bWorkload\x12\x1c\n" +
	"\tnamespace\x18\x01 \x01(\tR\tnamespace\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12Q\n" +
	"\vannotations\x18\x03 \x03(\v2/.wasmcloud.runtime.v2.Workload.AnnotationsEntryR\vannotations\x127\n" +
	"\aservice\x18\x04 \x01(\v2\x1d.wasmcloud.runtime.v2.ServiceR\aservice\x12;\n" +
	"\twit_world\x18\x05 \x01(\v2\x1e.wasmcloud.runtime.v2.WitWorldR\bwitWorld\x126\n" +
	"\avolumes\x18\x06 \x03(\v2\x1c.wasmcloud.runtime.v2.VolumeR\avolumes\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xb7\x02\n" +
	"\aService\x12\x14\n" +
	"\x05image\x18\x01 \x01(\tR\x05image\x12M\n" +
	"\x0flocal_resources\x18\x02 \x01(\v2$.wasmcloud.runtime.v2.LocalResourcesR\x0elocalResources\x12!\n" +
	"\fmax_restarts\x18\x03 \x01(\x04R\vmaxRestarts\x12Q\n" +
	"\x11image_pull_secret\x18\x04 \x01(\v2%.wasmcloud.runtime.v2.ImagePullSecretR\x0fimagePullSecret\x12Q\n" +
	"\x11image_pull_policy\x18\x05 \x01(\x0e2%.wasmcloud.runtime.v2.ImagePullPolicyR\x0fimagePullPolicy\"\x98\x01\n" +
	"\bWitWorld\x12?\n" +
	"\n" +
	"components\x18\x01 \x03(\v2\x1f.wasmcloud.runtime.v2.ComponentR\n" +
	"components\x12K\n" +
	"\x0fhost_interfaces\x18\x02 \x03(\v2\".wasmcloud.runtime.v2.WitInterfaceR\x0ehostInterfaces\"\xbc\x04\n" +
	"\tComponent\x12\x14\n" +
	"\x05image\x18\x01 \x01(\tR\x05image\x12M\n" +
	"\x0flocal_resources\x18\x02 \x01(\v2$.wasmcloud.runtime.v2.LocalResourcesR\x0elocalResources\x12\x1b\n" +
	"\tpool_size\x18\x03 \x01(\x11R\bpoolSize\x12'\n" +
	"\x0fmax_invocations\x18\x04 \x01(\x11R\x0emaxInvocations\x12Q\n" +
	"\x11image_pull_secret\x18\x05 \x01(\v2%.wasmcloud.runtime.v2.ImagePullSecretR\x0fimagePullSecret\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\x12Q\n" +
	"\x11image_pull_policy\x18\a \x01(\x0e2%.wasmcloud.runtime.v2.ImagePullPolicyR\x0fimagePullPolicy\x12_\n" +
	"\x10interface_config\x18\b \x03(\v24.wasmcloud.runtime.v2.Component.InterfaceConfigEntryR\x0finterfaceConfig\x1ai\n" +
	"\x14InterfaceConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.wasmcloud.runtime.v2.InterfaceConfigR\x05value:\x028\x01\"\x97\x01\n" +
	"\x0fInterfaceConfig\x12I\n" +
	"\x06config\x18\x01 \x03(\v21.wasmcloud.runtime.v2.InterfaceConfig.ConfigEntryR\x06config\x1a9\n" +
	"\vConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xe0\x03\n" +
	"\x0eLocalResources\x12&\n" +
	"\x0fmemory_limit_mb\x18\x01 \x01(\x05R\rmemoryLimitMb\x12\x1b\n" +
	"\tcpu_limit\x18\x02 \x01(\x05R\bcpuLimit\x12H\n" +
	"\x06config\x18\x03 \x03(\v20.wasmcloud.runtime.v2.LocalResources.ConfigEntryR\x06config\x12W\n" +
	"\venvironment\x18\x04 \x03(\v25.wasmcloud.runtime.v2.LocalResources.EnvironmentEntryR\venvironment\x12F\n" +
	"\rvolume_mounts\x18\x05 \x03(\v2!.wasmcloud.runtime.v2.VolumeMountR\fvolumeMounts\x12#\n" +
	"\rallowed_hosts\x18\x06 \x03(\tR\fallowedHosts\x1a9\n" +
	"\vConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\thost_path\x18\x02 \x01(\v2$.wasmcloud.runtime.v2.HostPathVolumeH\x00R\bhostPath\x12C\n" +
	"\tempty_dir\x18\x03 \x01(\v2$.wasmcloud.runtime.v2.EmptyDirVolumeH\x00R\bemptyDirB\r\n" +
	"\vvolume_type\"]\n" +
	"\vVolumeMount\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"mount_path\x18\x02 \x01(\tR\tmountPath\x12\x1b\n" +
	"\tread_only\x18\x03 \x01(\bR\breadOnly\"\x10\n" +
	"\x0eEmptyDirVolume\"/\n" +
	"\x0eHostPathVolume\x12\x1d\n" +
	"\n" +
	"local_path\x18\x01 \x01(\tR\tlocalPath\"I\n" +
	"\x0fImagePullSecret\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword*\xdb\x01\n" +
	"\rWorkloadState\x12\x1e\n" +
	"\x1aWORKLOAD_STATE_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17WORKLOAD_STATE_STARTING\x10\x01\x12\x1a\n" +
	"\x16WORKLOAD_STATE_RUNNING\x10\x02\x12\x1c\n" +
	"\x18WORKLOAD_STATE_COMPLETED\x10\x03\x12\x1b\n" +
	"\x17WORKLOAD_STATE_STOPPING\x10\x04\x12\x18\n" +
	"\x14WORKLOAD_STATE_ERROR\x10\x05\x12\x1c\n" +
	"\x18WORKLOAD_STATE_NOT_FOUND\x10\x06*\x95\x01\n" +
	...
	"\x17IMAGE_PULL_POLICY_NEVER\x10\x03b\x06proto3"
...
var file_wasmcloud_runtime_v2_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_wasmcloud_runtime_v2_workload_proto_goTypes = []any{
	...
	(*InterfaceConfig)(nil), // 6: wasmcloud.runtime.v2.InterfaceConfig
	...
	nil,                     // 14: wasmcloud.runtime.v2.Component.InterfaceConfigEntry
	nil,                     // 15: wasmcloud.runtime.v2.InterfaceConfig.ConfigEntry
	nil,                     // 16: wasmcloud.runtime.v2.LocalResources.ConfigEntry
	nil,                     // 17: wasmcloud.runtime.v2.LocalResources.EnvironmentEntry
	(*WitInterface)(nil),    // 18: wasmcloud.runtime.v2.WitInterface
}
var file_wasmcloud_runtime_v2_workload_proto_depIdxs = []int32{
	...
	18, // 8: wasmcloud.runtime.v2.WitWorld.host_interfaces:type_name -> wasmcloud.runtime.v2.WitInterface
	7,  // 9: wasmcloud.runtime.v2.Component.local_resources:type_name -> wasmcloud.runtime.v2.LocalResources
	12, // 10: wasmcloud.runtime.v2.Component.image_pull_secret:type_name -> wasmcloud.runtime.v2.ImagePullSecret
	1,  // 11: wasmcloud.runtime.v2.Component.image_pull_policy:type_name -> wasmcloud.runtime.v2.ImagePullPolicy
	14, // 12: wasmcloud.runtime.v2.Component.interface_config:type_name -> wasmcloud.runtime.v2.Component.InterfaceConfigEntry
	15, // 13: wasmcloud.runtime.v2.InterfaceConfig.config:type_name -> wasmcloud.runtime.v2.InterfaceConfig.ConfigEntry
	16, // 14: wasmcloud.runtime.v2.LocalResources.config:type_name -> wasmcloud.runtime.v2.LocalResources.ConfigEntry
	17, // 15: wasmcloud.runtime.v2.LocalResources.environment:type_name -> wasmcloud.runtime.v2.LocalResources.EnvironmentEntry
	...
	6,  // 19: wasmcloud.runtime.v2.Component.InterfaceConfigEntry.value:type_name -> wasmcloud.runtime.v2.InterfaceConfig
