...
func (in *ArtifactStatus) DeepCopyInto(out *ArtifactStatus) {
	*out = *in
	...
	if in.Precompiled != nil {
		in, out := &in.Precompiled, &out.Precompiled
		*out = make([]PrecompiledVariant, len(*in))
		copy(*out, *in)
	}
}
...
func (in *LocalResources) DeepCopyInto(out *LocalResources) {
	*out = *in
	...
	if in.AllowedHostLoopbackPorts != nil {
		in, out := &in.AllowedHostLoopbackPorts, &out.AllowedHostLoopbackPorts
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrecompiledVariant) DeepCopyInto(out *PrecompiledVariant) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrecompiledVariant.
func (in *PrecompiledVariant) DeepCopy() *PrecompiledVariant {
	if in == nil {
		return nil
	}
	out := new(PrecompiledVariant)
	in.DeepCopyInto(out)
	return out
}
